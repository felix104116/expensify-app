...
const expenseTwo = store.dispatch(addExpense({description: 'Car', amount:10000, createdAt: 100000}));
const expenseOne = store.dispatch(addExpense({description: 'Rent', amount:100000, createdAt: 1000}));
store.dispatch(setStartDate(100));
store.dispatch(setEndDate(10000000));
store.dispatch(sortByAmount());
//store.dispatch(setTextFilter('Car'));
//store.dispatch(sortByDate());
//store.dispatch(removeExpense({ id: expenseOne.expense.id}));
//store.dispatch(editExpense(expenseTwo.expense.id, {amount:750000}));
